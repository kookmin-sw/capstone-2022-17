...
public class ResponseMessage {
    ...
    public static final String PROJECT_LIKE_ADD_SUCCESS = "프로젝트 좋아요 성공";
    public static final String PROJECT_SEARCH_SUCCESS = "프로젝트 둘러보기 조회 성공";
    ...
    public static final String GET_RECOMMEND_USER_SUCCESS = "추천 유저 조회 성공";
